    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center space-y-8">
        <div className="relative">
          ...
          <Tractor size={32} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primary animate-pulse" />
        </div>
        <div className="text-center space-y-2">
          <p className="text-xl font-black tracking-tighter uppercase italic">Inventory Sync</p>
          <p className="text-[10px] font-black uppercase tracking-[0.5em] text-muted-foreground animate-pulse">Scanning Global Farm-Assets</p>
        </div>
      </div>
    );
  }
  ...
  if (isError) return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="glass p-12 rounded-[3rem] border-destructive/20 text-center space-y-6 max-w-md">
        ...
        <p className="text-sm font-medium text-muted-foreground leading-relaxed">Failed to establish secure handshake with the equipment database. Please verify your connection.</p>
    ...
    <div className="p-6 lg:p-12 max-w-[1600px] mx-auto min-h-screen space-y-16">
      ...
      {(!filteredList || filteredList.length === 0) ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredList.map((eq: Equipment, idx: number) => (
            ...
            >
              ...
              <div className="relative mb-8 rounded-[2rem] overflow-hidden aspect-[4/5] bg-muted">
                 ...
                 <div className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-8">
                    <div className="p-3 bg-primary/20 backdrop-blur-xl rounded-2xl border border-primary/20">
              ...
              <div className="mb-10 space-y-4">
                <div className="space-y-1">
                   <h3 className="font-black text-2xl tracking-tighter italic leading-none">{eq.name}</h3>
          ...
          <div ref={ref} className="col-span-full py-20 flex flex-col items-center justify-center gap-4">
            {isFetchingNextPage ? (
              <>
